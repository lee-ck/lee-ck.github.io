...
[[Image from Prof.Rolf Findeisen's slides](http://ifatwww.et.uni-magdeburg.de/syst/cdc2012/workshopallslides.pdf)]{: width="400"}{: .align-center}
...
> **Assumption 2.** </br>
> Terminal set is ***invariant*** under the local control law $v(x_k)$. </br>
